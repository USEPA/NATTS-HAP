...
#  based on 5 year average chemical cancer risks. The resulting df is then      #
#  used by a python script to create pie charts that show % contribution from   #
#  each chem class and are graphed onto a map of the US                         #
#################################################################################
...
### Calculate average 5 year cancer risk for each site-chemical_class 
...
### Calculate % contribution to cancer risk for each site-chemical_class
